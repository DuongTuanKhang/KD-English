...
$META_TITLE = "DungDepTrai - Nền tảng học ngoại ngữ online";
$META_IMAGE = "https://i.imgur.com/Ldhl3hK.png";
$META_DESCRIPTION = "DungDepTrai - Nền tảng học ngoại ngữ online";
$META_SITE = BASE_URL("");
        ...
        <div class="slider-wrap">
            <div class="slider__content">
                <h1 class="slider__content-heading">Học
                    ...
                    <div style="line-height:0" class="headline-icon"><img src="https://i.imgur.com/HE3eJGR.png"
                            loading="lazy" class="LazyImage__Img-sc-12k26ab-0 eVDYkS"></div>
                    <div style="line-height:0;top: -40px;right: -40px;" class="headline-icon"><img
                            src="https://i.imgur.com/GF5UgJs.png" loading="lazy"
                            class="LazyImage__Img-sc-12k26ab-0 eVDYkS"></div>
                    <div style="line-height:0; top: -40px;right: -40px;" class="headline-icon"><img
                            src="https://i.imgur.com/fmKnI8E.png" loading="lazy"
                            class="LazyImage__Img-sc-12k26ab-0 eVDYkS"></div>
            ...
            <div class="slider__img">
                <img src="https://i.imgur.com/dGnCisl.png" loading="lazy"
                    alt="<?= $Database->site("TenWeb") . ' - Nền tảng học ngoại ngữ online' ?>" class="image">
                <img src="https://i.imgur.com/ezm9DcC.png" loading="lazy"
                    alt="<?= $Database->site("TenWeb") . ' - Nền tảng học ngoại ngữ online' ?>" class="image_1">
                <img src="https://i.imgur.com/aVPB2Ll.png" loading="lazy"
                    alt="<?= $Database->site("TenWeb") . ' - Nền tảng học ngoại ngữ online' ?>" class="image_2">
                <img src="https://i.imgur.com/nci9dng.png" loading="lazy"
                    alt="<?= $Database->site("TenWeb") . ' - Nền tảng học ngoại ngữ online' ?>" class="image_3">
    ...
    <div class="course">
        <ul class="course__list">
            ...
            <li class="course__item nation course__item--separate">
                <img src="<?= BASE_URL("/") ?>/assets/img/America.png"
                    alt="<?= $Database->site("TenWeb") . ' - Khóa học tiếng Anh' ?>" class="course__item-img">
                <div class="course__item-text">TIẾNG ANH</div>
            </li>
            <li class="course__item nation">
                <img src="<?= BASE_URL("/") ?>/assets/img/Japan.png"
                    alt="<?= $Database->site("TenWeb") . ' - Khóa học tiếng Nhật' ?>" class="course__item-img">
        ...
        <div class="why_use_container">
            ...
            <div class="reason__content">
                <div class="reason__warp-img " style="background-color: #A2D6E5;">
                    <img class="reason__img" src="https://i.imgur.com/Q9GYNuV.png"
                        alt="<?= $Database->site("TenWeb") . ' - Các kỹ thuật ghi nhớ được khoa học chứng minh' ?>">
                </div>
            ...
            <div class="reason__content">
                <div class="reason__warp-img " style="background-color: #D0C9E7;">
                    <img class="reason__img" src="https://i.imgur.com/x2hi4Fq.png"
                        alt="<?= $Database->site("TenWeb") . ' - Học nhanh hơn gấp hai lần so với trên lớp' ?>">
                </div>
            ...
            <div class="reason__content">
                <div class="reason__warp-img " style="background-color: #8AD6C2;">
                    <img class="reason__img" src="https://i.imgur.com/9ifba7t.png"
                        alt="<?= $Database->site("TenWeb") . ' - Học bằng cách đắm mình trong ngôn ngữ, như thế bạn đang sống ở đó vậy' ?>">
                </div>
            ...
            <div class="reason__content">
                <div class="reason__warp-img " style="background-color: #F6C2C3;">
                    <img class="reason__img" src="https://i.imgur.com/lqi2N7I.png"
                        alt="<?= $Database->site("TenWeb") . ' - Bao quát mọi thứ từ những kiến thức thiết yếu cho những chuyến du lịch của bạn tới những mục tiêu dài hạn hơn' ?>">
                </div>
...
<div class="introduce">
    <div class="grid wide">
        ...
        <div class="introduce_platform">
            ...
            <div class="introduce__content">
                <div class="introduce__wrap-img">
                    <img src="<?= BASE_URL("/") ?>/assets/img/menu.png"
                        alt="<?= $Database->site("TenWeb") . ' - Lộ trình học tập được xây dựng cho riêng bạn' ?>"
                        class="introduce__content-img">
                </div>
            ...
            <div class="introduce__content">
                <div class="introduce__wrap-img">
                    <img src="<?= BASE_URL("/") ?>/assets/img/book.png"
                        alt="<?= $Database->site("TenWeb") . ' - Danh sách từ vựng phong phú và thiết thực' ?>"
                        class="introduce__content-img">
                </div>
            ...
            <div class="introduce__content">
                <div class="introduce__wrap-img">
                    <img src="<?= BASE_URL("/") ?>/assets/img/free.png"
                        alt="<?= $Database->site("TenWeb") . ' - Nền tảng miễn phí, bất cứ ai cũng có thể học, nó là miễn phí' ?>"
                        class="introduce__content-img">
                </div>
...
">
    <div class="introduce_website">
        <div class="introduce_website-left">
            ...
            <p class="support-browser__content">Khác với các từ điển thông thường. Chúng tôi xây dựng từ điển của mình
                theo hướng người Việt giúp mang lại từ vựng có nghĩa chính xác nhất theo định nghĩa tiếng Việt.</p>
        </div>
        <div class="introduce_website-right">
            <img src="https://i.imgur.com/aDm5Pgc.png"
                alt="<?= $Database->site("TenWeb") . ' - Nhiều từ vựng được dịch nghĩa chính xác nhất' ?>" />
        </div>
    </div>
</div>
<div style="
...
">
    <div class="introduce_website">
        <div class="introduce_website-right">
            <img src="https://i.imgur.com/RjfROrU.png"
                alt="<?= $Database->site("TenWeb") . ' - Ví dụ cụ thể cho từng từ' ?>" />
        </div>
        <div class="introduce_website-left">
            <h1 class="introduce__heading">Ví dụ cụ thể cho từng từ</h1>
            <p class="support-browser__content">Với mỗi từ tiếng Anh sẽ có 1-2 ví dụ tương ứng, giúp các bạn nắm được
                cách mà từ này được sử dụng trong câu ứng với ngữ cảnh thực tế.</p>
        </div>
                ...
                <div class="comment-item">
                    <div class="comment-item__wrap">
                        <div class="comment-left">
                            <img src="<?= $danhGiaKhoaHoc["AnhDaiDien"] ?>" alt="<?= $danhGiaKhoaHoc["TenHienThi"] ?>"
                                class="comment-left__img">
...
">
    <div class="support-browser">
        ...
        <p class="support-browser__content">Nền tảng học ngoại ngữ <?= $Database->site("TenWeb") ?> hỗ trợ có thể tương
            tác với tất cả các trình duyệt máy tính để bàn và thiết bị di động hiện đại, và đã được kiểm tra kỹ lưỡng để
            đạt được hiệu suất và độ tin cậy trong phạm vi trình duyệt rộng nhất có thể.</p>
        <div class="support-browser__list-browser">
            <div class="support-browser__item">
                <img src="https://i.imgur.com/Dp6UTr8.png" alt="<?= $Database->site("TenWeb") ?> - Học trên Firefox"
                    class="support-browser__item-img">
                <div class="support-browser__item-name">Firefox</div>
            </div>
            <div class="support-browser__item">
                <img src="<?= BASE_URL("/") ?>/assets/img/chrome.svg"
                    alt="<?= $Database->site("TenWeb") ?> - Học trên Chrome" class="support-browser__item-img">
                <div class="support-browser__item-name">Chrome</div>
            </div>
            <div class="support-browser__item">
                <img src="<?= BASE_URL("/") ?>/assets/img/safari.svg"
                    alt="<?= $Database->site("TenWeb") ?> - Học trên Safari" class="support-browser__item-img">
                <div class="support-browser__item-name">Safari</div>
            </div>
            <div class="support-browser__item">
                <img src="<?= BASE_URL("/") ?>/assets/img/opera.svg"
                    alt="<?= $Database->site("TenWeb") ?> - Học trên Opera" class="support-browser__item-img">
